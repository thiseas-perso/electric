...
const Home = ({ allDataLight }) => {
  ...
  return (
    <>
      ...
      <div className=" flex flex-col  min-h-[100vh] bg-[url('../public/images/tesla_2_md_light.jpg')] bg-cover bg-center flex-grow dark:bg-[url('../public/images/tesla_2_md_dark.jpg')]">
